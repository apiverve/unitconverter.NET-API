...
namespace APIVerve
{
    public class UnitConverterAPIClient
    {
        ...
        public UnitConverterAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public UnitConverterAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(unitconverterQueryOptions options)
        {
            try
            {
                if (_isDebug)
